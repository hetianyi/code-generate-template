// #MvcTemplate#
package com.github.hetianyi.plugin.template.service.impl;
...
import com.github.hetianyi.plugin.template.mapper.ExampleMapper;
...
public class ExampleServiceImpl extends ServiceImpl<ExampleMapper, ExamplePO> implements ExampleService {
    ...
    @Override
    public ExampleVO getById(String exampleId) {
        ExamplePO examplePO = this.baseMapper.selectById(Long.valueOf(exampleId));
